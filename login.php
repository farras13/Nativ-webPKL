...
<head>
  ...
  <title>Login Sistem Informasi Manajemen PKL Politeknik Negeri Malang</title>
      ...
      <form action="login/login-proses.php" method="post">
        <div class="form-group has-feedback">
          <select name="level" class="form-control" required="">
            ...
            <option value="Panitia">Panitia PKL</option>
            <option value="Dosen">Dosen</option>
            <option value="Lapangan">Pembimbing Lapangan</option>
