...
<head>
  ...
  <title>Sistem Informasi PKL Politeknik Negeri Malang</title>
...
<body class="hold-transition skin-blue sidebar-mini">
  ...
  <div class="wrapper">
    <div class="logo">
      <img src="../images/logopolinema.png" class="img-logo">
      <span class="jd-logo">Sistem Informasi PKL</span>
      <span class="nm-sek">Politeknik Negeri Malang</span>
    </div>
    ...
    <footer class="main-footer">
      ...
      &copy; Copyright <?php echo date('Y');  ?> TiYun
    </footer>
