                  ...
                  <div class="table-responsive">     
                   <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $no=0;
                      $sql=mysqli_query($koneksi,"SELECT * FROM tb_mhs,tb_instansi,tb_penempatan where tb_penempatan.nobp=tb_mhs.nobp and tb_penempatan.kd_instansi=tb_instansi.kd_instansi and tb_mhs.nobp='$_GET[id]'");
