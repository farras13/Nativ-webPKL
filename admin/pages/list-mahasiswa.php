                ...
                <div class="box-body">
                  ...
                  <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      $no=0;
                    $sql=mysqli_query($koneksi,"SELECT tb_mhs.*,tb_dosen.nm_dosen FROM tb_mhs,tb_dosen where tb_mhs.nidn_pembimbing=tb_dosen.nidn");
                     ...
                     ?>
                      <tr>
                        ...
                        <td><?php echo $q['password']; ?></td>
                         <td>
                          <a href="index.php?p=edit-mahasiswa&id=<?php echo $q['nobp']; ?>" class="btn btn-success"><i class="fa fa-pencil"></i></a>
                          <a href="./pages/delete-mahasiswa.php?id=<?php echo $q['nobp']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
