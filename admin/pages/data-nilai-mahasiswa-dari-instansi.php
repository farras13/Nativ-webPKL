            ...
            <div class="col-xs-12">
              ...
              <div class="box">
                ...
                <div class="box-body">
                    ...
                    $q=mysqli_fetch_array(mysqli_query($koneksi,"SELECT tb_mhs.*,tb_nilai_instansi.*,tb_instansi.nm_instansi,tb_penempatan.posisi FROM tb_nilai_instansi,tb_mhs,tb_instansi,tb_penempatan where tb_instansi.kd_instansi=tb_nilai_instansi.kd_instansi and tb_mhs.nobp=tb_nilai_instansi.nobp and tb_penempatan.nobp=tb_mhs.nobp and tb_mhs.nidn_pembimbing='$id' and tb_mhs.nobp='$_GET[nobp]'"));

                    $total=$q['disiplin']+$q['jujur']+$q['sosialisasi']+$q['k_manajerial']+$q['komunikasi']+$q['k_komputer']+$q['k_tim']+$q['p_ilmu_penunjang']+$q['kwa_hasil_kerja']+$q['motivasi_hal_baru'];
                    $nilai=$total/10;
                    ?> 
                    <div class="col-md-6">
                     <div class="row mhs">
